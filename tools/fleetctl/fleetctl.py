#!/usr/bin/env python3
"""fleetctl -- deploy firmware to the iot_ai ESP32 fleet from the gateway.
...
build toolchain stays the canonical Espressif one.
    ...
    python fleetctl.py devices                       # list attached boards
    python fleetctl.py flash --board sunfounder      # build + flash over USB
    python fleetctl.py flash --board sunfounder --version 0.2.0 --port /dev/ttyUSB0
    python fleetctl.py versions                       # what we've deployed
